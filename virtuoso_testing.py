                ...
                if next_execution_time:
                    ...
                    for goal_id, goal_data in details.items():
                        ...
                        detailed_summary[team['team_name']][planner_name][goal_name] = {
                            "executed": goal_data['executed'],
                            "passed": goal_data['passed'],
                            "failed": goal_data['failed'],
                            "details": goal_data
                        }
...
def export_summary_csv(team_data, summary_file, detailed_summary_file_path, detailed_summary):
    ...
    fieldnames = ["Team Name", "Execution Planner Name", "Goal Name", "Total journey Executed",
                  "Total journey Passed", "Total journey Failed", "Passed Journey Names", "Failed Journey Names"]
    ...
    with open(detailed_summary_file_path, 'w', newline='') as csvfile:
        ...
        for team_name, planners in detailed_summary.items():
            for planner_name, goals_data in planners.items():
                for goal_name, result in goals_data.items():
                    writer.writerow({
                        'Team Name': team_name,
                        'Execution Planner Name': planner_name,
                        'Goal Name': goal_name,
                        'Total journey Executed': result['executed'],
                        'Total journey Passed': result['passed'],
                        'Total journey Failed': result['failed'],
