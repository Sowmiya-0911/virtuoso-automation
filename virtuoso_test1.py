        ...
        for project in team['projects']:
            ...
            for planner_id in project['planner_id']:
                ...
                if next_execution_time:
                    executed, passed, failed, details = total_TC_executed_passed(project['project_id'], planner_id, api_token, next_execution_time, team['team_name'])
...
def export_summary_csv(team_data, summary_file, detailed_summary_file, detailed_summary):
    ...
    with open(detailed_summary_file, 'w', newline='') as csvfile:
        fieldnames = ['Team Name', 'Execution Planner Name', 'Goal Name', 'Total TC Executed', 'Total TC Passed', 'Total Failed']
        writer = csv.DictWriter(csvfile, fieldnames=fieldnames)
...
if __name__ == "__main__":
    ...
    try:
        ...
        export_summary_csv(team_data, 'summary1.csv', detailed_summary_file, detailed_summary)
